...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A4C567411A
	for <lists+linux-nvdimm@lfdr.de>; Wed, 24 Jul 2019 23:58:00 +0200 (CEST)
Received: from [127.0.0.1] (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 337CF2194D387;
	Wed, 24 Jul 2019 15:00:18 -0700 (PDT)
...
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 ...
 by ml01.01.org (Postfix) with ESMTPS id 87D66212DC5AD
 for <linux-nvdimm@lists.01.org>; Wed, 24 Jul 2019 15:00:15 -0700 (PDT)
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,304,1559545200"; d="scan'208";a="193602229"
Received: from vverma7-desk1.lm.intel.com ([10.232.112.185])
 by fmsmga004.fm.intel.com with ESMTP; 24 Jul 2019 14:57:48 -0700
From: Vishal Verma <vishal.l.verma@intel.com>
To: <linux-nvdimm@lists.01.org>
Subject: [ndctl PATCH v7 07/13] daxctl: add a new reconfigure-device command
Date: Wed, 24 Jul 2019 15:57:35 -0600
Message-Id: <20190724215741.18556-8-vishal.l.verma@intel.com>
...
+	if (!mem) {
+		fprintf(stderr, "%s: unable to get the memory object: %s\n",
+			devname, strerror(-rc));
+		return -ENXIO;
+	}
