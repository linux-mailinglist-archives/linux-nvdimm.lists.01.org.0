...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A582284470
	for <lists+linux-nvdimm@lfdr.de>; Tue,  6 Oct 2020 05:58:57 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id BBE5B155405DE;
	Mon,  5 Oct 2020 20:58:55 -0700 (PDT)
...
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
	...
	by ml01.01.org (Postfix) with ESMTPS id AD815154B1F5E
	for <linux-nvdimm@lists.01.org>; Mon,  5 Oct 2020 20:58:51 -0700 (PDT)
IronPort-SDR: W2I/1nJg8FtoTs26xLXlM8mdRcAA9AL2Ndb8UFZzFCvE9qfMnJOlIc2KmdXRgZXcKt7KvK4HsS
 l1qE4qI+w5XQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9765"; a="181782461"
X-IronPort-AV: E=Sophos;i="5.77,341,1596524400";
   d="scan'208";a="181782461"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Oct 2020 20:58:49 -0700
...
MIME-Version: 1.0
Message-ID-Hash: QVMEVS3U5BJMR62LAR37FKYBMK55BC6L
X-Message-ID-Hash: QVMEVS3U5BJMR62LAR37FKYBMK55BC6L
X-MailFrom: dan.j.williams@intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: x86@kernel.org, stable@vger.kernel.org, Ingo Molnar <mingo@redhat.com>, "H. Peter Anvin" <hpa@zytor.com>, Paul Mackerras <paulus@samba.org>, Thomas Gleixner <tglx@linutronix.de>, Peter Zijlstra <peterz@infradead.org>, Mikulas Patocka <mpatocka@redhat.com>, Alexander Viro <viro@zeniv.linux.org.uk>, Arnaldo Carvalho de Melo <acme@kernel.org>, Linus Torvalds <torvalds@linux-foundation.org>, Benjamin Herrenschmidt <benh@kernel.crashing.org>, Tony Luck <tony.luck@intel.com>, Michael Ellerman <mpe@ellerman.id.au>, linux-kernel@vger.kernel.org, linux-nvdimm@lists.01.org
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/QVMEVS3U5BJMR62LAR37FKYBMK55BC6L/>
