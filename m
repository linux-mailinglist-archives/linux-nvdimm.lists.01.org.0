...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 67D427411C
	for <lists+linux-nvdimm@lfdr.de>; Wed, 24 Jul 2019 23:58:03 +0200 (CEST)
Received: from [127.0.0.1] (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id BCA8E212DC5A9;
...
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 ...
 by ml01.01.org (Postfix) with ESMTPS id 47CA32194EB7A
 for <linux-nvdimm@lists.01.org>; Wed, 24 Jul 2019 15:00:16 -0700 (PDT)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 24 Jul 2019 14:57:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,304,1559545200"; d="scan'208";a="193602235"
Received: from vverma7-desk1.lm.intel.com ([10.232.112.185])
 by fmsmga004.fm.intel.com with ESMTP; 24 Jul 2019 14:57:49 -0700
From: Vishal Verma <vishal.l.verma@intel.com>
To: <linux-nvdimm@lists.01.org>
Subject: [ndctl PATCH v7 09/13] daxctl: add commands to online and offline
 memory
Date: Wed, 24 Jul 2019 15:57:37 -0600
Message-Id: <20190724215741.18556-10-vishal.l.verma@intel.com>
...
+	struct json_object *jdevs = NULL;
 	...
 	int rc = -ENXIO;
@@ -307,10 +389,23 @@ static int do_xaction_device(const char *device, enum device_action action,
...
+				break;
 			default:
 				rc = -EINVAL;
 				break;
@@ -345,3 +440,37 @@ int cmd_reconfig_device(int argc, const char **argv, struct daxctl_ctx *ctx)
 			processed == 1 ? "" : "s");
 	return rc;
 }
+
