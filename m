...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id DFCAC2353D4
	for <lists+linux-nvdimm@lfdr.de>; Sat,  1 Aug 2020 19:39:16 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 9604F119BC048;
	Sat,  1 Aug 2020 10:39:15 -0700 (PDT)
...
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
	...
	by ml01.01.org (Postfix) with ESMTPS id DE621119BC048
	for <linux-nvdimm@lists.01.org>; Sat,  1 Aug 2020 10:39:13 -0700 (PDT)
IronPort-SDR: RN5ZlbdZjJr/OGJwhpkyLNVIbp1mkr0W/GqgYqtN9Tg/sHA8q80ZYSdSndAFsPV54yq2aV9vDe
 Nc3bHGvqgDgg==
X-IronPort-AV: E=McAfee;i="6000,8403,9700"; a="149756066"
X-IronPort-AV: E=Sophos;i="5.75,423,1589266800";
   d="scan'208";a="149756066"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Aug 2020 10:39:01 -0700
...
MIME-Version: 1.0
Message-ID-Hash: NN7LPR3PZRYBEZBCM5YLXLE2CQE2VZ4Z
X-Message-ID-Hash: NN7LPR3PZRYBEZBCM5YLXLE2CQE2VZ4Z
X-MailFrom: dan.j.williams@intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: x86@kernel.org, stable@vger.kernel.org, Borislav Petkov <bp@alien8.de>, "H. Peter Anvin" <hpa@zytor.com>, Paul Mackerras <paulus@samba.org>, Peter Zijlstra <peterz@infradead.org>, Mikulas Patocka <mpatocka@redhat.com>, Alexander Viro <viro@zeniv.linux.org.uk>, Arnaldo Carvalho de Melo <acme@kernel.org>, Linus Torvalds <torvalds@linux-foundation.org>, Benjamin Herrenschmidt <benh@kernel.crashing.org>, Tony Luck <tony.luck@intel.com>, Michael Ellerman <mpe@ellerman.id.au>, linux-nvdimm@lists.01.org, linux-kernel@vger.kernel.org
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/NN7LPR3PZRYBEZBCM5YLXLE2CQE2VZ4Z/>
