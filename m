...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id ED999275E15
	for <lists+linux-nvdimm@lfdr.de>; Wed, 23 Sep 2020 19:00:23 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id A0DB0153298BE;
	Wed, 23 Sep 2020 10:00:22 -0700 (PDT)
...
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
	...
	by ml01.01.org (Postfix) with ESMTPS id CBAAE153298BB
	for <linux-nvdimm@lists.01.org>; Wed, 23 Sep 2020 10:00:20 -0700 (PDT)
IronPort-SDR: lEnCANq/kwCgDe2UvhmTBEZoFbv6jNri1XCnGmNSbWpN/ttpoBn0YmXxBkFtA0Z4spa6ZVH/qn
 n2HI8rpmbxPA==
X-IronPort-AV: E=McAfee;i="6000,8403,9753"; a="161028444"
X-IronPort-AV: E=Sophos;i="5.77,293,1596524400";
   d="scan'208";a="161028444"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Sep 2020 10:00:20 -0700
...
MIME-Version: 1.0
Message-ID-Hash: QSH7QEJTT5NSTXEHCJQ6XUCQCWVPJIOC
X-Message-ID-Hash: QSH7QEJTT5NSTXEHCJQ6XUCQCWVPJIOC
X-MailFrom: dan.j.williams@intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: x86@kernel.org, stable@vger.kernel.org, Borislav Petkov <bp@alien8.de>, "H. Peter Anvin" <hpa@zytor.com>, Paul Mackerras <paulus@samba.org>, tglx@linutronix.de, Peter Zijlstra <peterz@infradead.org>, Mikulas Patocka <mpatocka@redhat.com>, Alexander Viro <viro@zeniv.linux.org.uk>, Arnaldo Carvalho de Melo <acme@kernel.org>, Linus Torvalds <torvalds@linux-foundation.org>, Benjamin Herrenschmidt <benh@kernel.crashing.org>, Tony Luck <tony.luck@intel.com>, Michael Ellerman <mpe@ellerman.id.au>, linux-nvdimm@lists.01.org, linux-kernel@vger.kernel.org, jack@suse.cz
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/QSH7QEJTT5NSTXEHCJQ6XUCQCWVPJIOC/>
