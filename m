...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id D2B631BF319
	for <lists+linux-nvdimm@lfdr.de>; Thu, 30 Apr 2020 10:41:18 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 0BBB11107E248;
	Thu, 30 Apr 2020 01:40:08 -0700 (PDT)
...
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
	...
	by ml01.01.org (Postfix) with ESMTPS id 63C0F10FC5BE3
	for <linux-nvdimm@lists.01.org>; Thu, 30 Apr 2020 01:40:04 -0700 (PDT)
IronPort-SDR: BMcFIdd7+LieSC2f/UFN4ft8orL88368lzKVWSFBcHeWtfGnC2WslfylzXla5/lqYJjanYNtDS
 7vULsfjzn25Q==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Apr 2020 01:41:13 -0700
...
MIME-Version: 1.0
Message-ID-Hash: JKUZC7ZMSONIU5NPUEB6MXPMQWQ2YT4V
X-Message-ID-Hash: JKUZC7ZMSONIU5NPUEB6MXPMQWQ2YT4V
X-MailFrom: dan.j.williams@intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: x86@kernel.org, stable@vger.kernel.org, Borislav Petkov <bp@alien8.de>, "H. Peter Anvin" <hpa@zytor.com>, Peter Zijlstra <peterz@infradead.org>, Tony Luck <tony.luck@intel.com>, Michael Ellerman <mpe@ellerman.id.au>, Benjamin Herrenschmidt <benh@kernel.crashing.org>, Paul Mackerras <paulus@samba.org>, Arnaldo Carvalho de Melo <acme@kernel.org>, Linus Torvalds <torvalds@linux-foundation.org>, linux-nvdimm@lists.01.org, linux-kernel@vger.kernel.org
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/JKUZC7ZMSONIU5NPUEB6MXPMQWQ2YT4V/>
