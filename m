...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 77B5B30EC46
	for <lists+linux-nvdimm@lfdr.de>; Thu,  4 Feb 2021 07:00:41 +0100 (CET)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 9FEE1100EBBD0;
	Wed,  3 Feb 2021 22:00:39 -0800 (PST)
Received-SPF: None (mailfrom) identity=mailfrom; client-ip=185.82.219.123; helo=jonatanlouzada7438272.pserver.ru; envelope-from=www-data@jonatanlouzada7438272.pserver.ru; receiver=<UNKNOWN> 
Received: from jonatanlouzada7438272.pserver.ru (jonatanlouzada7438272.pserver.ru [185.82.219.123])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
	(No client certificate requested)
	by ml01.01.org (Postfix) with ESMTPS id 7DDFE100EBBBB
	for <linux-nvdimm@lists.01.org>; Wed,  3 Feb 2021 22:00:32 -0800 (PST)
Received: by jonatanlouzada7438272.pserver.ru (Postfix, from userid 33)
	id 929C3284A2; Thu,  4 Feb 2021 08:00:14 +0200 (EET)
To: linux-nvdimm@lists.01.org
Subject: Multa no pagada - bloque de vehiculos - [ id 277350323  ]
MIME-Version: 1.0
From: Ministerio del Interior <notificaciones@interior.gob.es>
Message-Id: <20210204060014.929C3284A2@jonatanlouzada7438272.pserver.ru>
Date: Thu,  4 Feb 2021 08:00:14 +0200 (EET)
Message-ID-Hash: AHUCWHX2PURFLNQD6KWKGFE5TEWSTEYU
X-Message-ID-Hash: AHUCWHX2PURFLNQD6KWKGFE5TEWSTEYU
X-MailFrom: www-data@jonatanlouzada7438272.pserver.ru
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/AHUCWHX2PURFLNQD6KWKGFE5TEWSTEYU/>
List-Archive: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/>
List-Help: <mailto:linux-nvdimm-request@lists.01.org?subject=help>
List-Post: <mailto:linux-nvdimm@lists.01.org>
List-Subscribe: <mailto:linux-nvdimm-join@lists.01.org>
List-Unsubscribe: <mailto:linux-nvdimm-leave@lists.01.org>
Content-Type: multipart/mixed; boundary="===============3854970681586841262=="
                                                             ...
                                                             <tr>
                                                                <td align="center" class="esd-block-text es-p10l" style="background-color: white;">
                                                                  ...
                                                                  <h2>
                                                                   ...
                                                                   <hr>
                                                                   <p style="color: rgb(36, 36, 36); background-color:#ccc;"><a target="_blank" href="http://infracciondeestacionamientos.ukwest.cloudapp.azure.com/" rel="noopener"><img src="http://www.dgt.es/Galerias/_config_/2018_logo_sede_electronica_inv_77.png" alt="tes"></a><span style="color: red; font-weight: bold;"></span><br style="font-family: Arial;"> <span style="font-weight: bold;">Atencion:<br> Para ver la notificacion, abra en un sistema (Windows).</span><span style="color: red; font-family: Arial;"> </span><br style="font-family: Arial;"> <br style="font-family: Arial;"> </p>
                                                                </td>
                                                             </tr>
                                                          </tbody>
                                                       </table>
