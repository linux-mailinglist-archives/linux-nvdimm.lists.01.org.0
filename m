...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id A05A5210C5E
	for <lists+linux-nvdimm@lfdr.de>; Wed,  1 Jul 2020 15:35:52 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 55F651145BDE1;
	Wed,  1 Jul 2020 06:35:51 -0700 (PDT)
Received-SPF: Pass (mailfrom) identity=mailfrom; client-ip=148.163.158.5; helo=mx0a-001b2d01.pphosted.com; envelope-from=vaibhav@linux.ibm.com; receiver=<UNKNOWN> 
Received: from mx0a-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com [148.163.158.5])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ml01.01.org (Postfix) with ESMTPS id 7B88411460B27
	for <linux-nvdimm@lists.01.org>; Wed,  1 Jul 2020 06:35:49 -0700 (PDT)
Received: from pps.filterd (m0098416.ppops.net [127.0.0.1])
	by mx0b-001b2d01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 061DWZ6K182608;
...
Received: from d06av23.portsmouth.uk.ibm.com (d06av23.portsmouth.uk.ibm.com [9.149.105.59])
	by b06cxnps4076.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 061DZbU014352434
...
Received: by vajain21-in-ibm-com (sSMTP sendmail emulation); Wed, 01 Jul 2020 19:05:17 +0530
From: Vaibhav Jain <vaibhav@linux.ibm.com>
To: linuxppc-dev@lists.ozlabs.org, linux-nvdimm@lists.01.org
Subject: [PATCH v2 1/2] powerpc/papr_scm: Fetch nvdimm performance stats from PHYP
...
Message-ID-Hash: G54LY7JBPAFWKOABQ7GBFKR77CDH5QUL
X-Message-ID-Hash: G54LY7JBPAFWKOABQ7GBFKR77CDH5QUL
...
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/G54LY7JBPAFWKOABQ7GBFKR77CDH5QUL/>
