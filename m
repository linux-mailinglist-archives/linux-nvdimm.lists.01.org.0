...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id A85D42162F1
	for <lists+linux-nvdimm@lfdr.de>; Tue,  7 Jul 2020 02:23:43 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 5E39F1108DEA3;
	Mon,  6 Jul 2020 17:23:42 -0700 (PDT)
...
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
	...
	by ml01.01.org (Postfix) with ESMTPS id 1D1A01108C539
	for <linux-nvdimm@lists.01.org>; Mon,  6 Jul 2020 17:23:39 -0700 (PDT)
IronPort-SDR: gdWgzH+7j5uT099JGGNxeUvjJhceON/csoa2kTbhtTpFIC23ob33uhoTlnvUGqAdy7H4hFr574
 eZv6qfp1eDWw==
X-IronPort-AV: E=McAfee;i="6000,8403,9674"; a="135765956"
X-IronPort-AV: E=Sophos;i="5.75,321,1589266800";
   d="scan'208";a="135765956"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Jul 2020 17:23:39 -0700
...
MIME-Version: 1.0
Message-ID-Hash: T5IL3WXPWR5SSE3MLHEM4FPC5OTMLXSP
X-Message-ID-Hash: T5IL3WXPWR5SSE3MLHEM4FPC5OTMLXSP
X-MailFrom: dan.j.williams@intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: x86@kernel.org, stable@vger.kernel.org, "H. Peter Anvin" <hpa@zytor.com>, Paul Mackerras <paulus@samba.org>, Peter Zijlstra <peterz@infradead.org>, Mikulas Patocka <mpatocka@redhat.com>, Alexander Viro <viro@zeniv.linux.org.uk>, Arnaldo Carvalho de Melo <acme@kernel.org>, Linus Torvalds <torvalds@linux-foundation.org>, Benjamin Herrenschmidt <benh@kernel.crashing.org>, Tony Luck <tony.luck@intel.com>, Michael Ellerman <mpe@ellerman.id.au>, linux-nvdimm@lists.01.org, linux-kernel@vger.kernel.org
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/T5IL3WXPWR5SSE3MLHEM4FPC5OTMLXSP/>
