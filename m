...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 263D831F3C1
	for <lists+linux-nvdimm@lfdr.de>; Fri, 19 Feb 2021 03:04:02 +0100 (CET)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id DDA42100EAB6A;
	Thu, 18 Feb 2021 18:03:56 -0800 (PST)
...
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
	...
	by ml01.01.org (Postfix) with ESMTPS id 18014100EBBD7
	for <linux-nvdimm@lists.01.org>; Thu, 18 Feb 2021 18:03:52 -0800 (PST)
IronPort-SDR: RkeL9bPEnyipwwIUbjbW3Bj46Y/9KIQ5UKtiZ6Kkl0Rd5NAJPRWCg44iThJFw9kOaSO69bazAq
 0KQDh6cxnZQg==
X-IronPort-AV: E=McAfee;i="6000,8403,9899"; a="181151493"
X-IronPort-AV: E=Sophos;i="5.81,187,1610438400";
   d="scan'208";a="181151493"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Feb 2021 18:03:51 -0800
IronPort-SDR: jdaKB+YDyDJ+IZ7gyMBIa3zfwDJz3BFkmpPIsLXcMA6PPjetnain+6Uggd3J6l4OBA/zhpQ1TM
 KDRBsk+TeEdg==
X-IronPort-AV: E=Sophos;i="5.81,187,1610438400";
   d="scan'208";a="513509636"
...
Subject: [ndctl PATCH v2 04/13] libcxl: add support for the 'Identify Device' command
Date: Thu, 18 Feb 2021 19:03:22 -0700
Message-Id: <20210219020331.725687-5-vishal.l.verma@intel.com>
...
MIME-Version: 1.0
Message-ID-Hash: CZIWYHZEQ5BQYSPI46LEZ2PMEJLEGIR5
X-Message-ID-Hash: CZIWYHZEQ5BQYSPI46LEZ2PMEJLEGIR5
...
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/CZIWYHZEQ5BQYSPI46LEZ2PMEJLEGIR5/>
