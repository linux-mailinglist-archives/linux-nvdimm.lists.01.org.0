...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 81CAFF24B8
	for <lists+linux-nvdimm@lfdr.de>; Thu,  7 Nov 2019 02:58:16 +0100 (CET)
Received: from new-ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 4D903100DC2B0;
	Wed,  6 Nov 2019 18:00:45 -0800 (PST)
...
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
	...
	by ml01.01.org (Postfix) with ESMTPS id 93834100DC3FF
	for <linux-nvdimm@lists.01.org>; Wed,  6 Nov 2019 18:00:43 -0800 (PST)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga105.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 06 Nov 2019 17:58:12 -0800
...
MIME-Version: 1.0
Message-ID-Hash: QBK2LFACGKNJYPVZ5OTL6QGT3OCPJYEY
X-Message-ID-Hash: QBK2LFACGKNJYPVZ5OTL6QGT3OCPJYEY
X-MailFrom: dan.j.williams@intel.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: Len Brown <lenb@kernel.org>, Keith Busch <kbusch@kernel.org>, "Rafael J. Wysocki" <rjw@rjwysocki.net>, Jonathan Cameron <Jonathan.Cameron@huawei.com>, Dave Hansen <dave.hansen@linux.intel.com>, peterz@infradead.org, ard.biesheuvel@linaro.org, x86@kernel.org, linux-acpi@vger.kernel.org, linux-kernel@vger.kernel.org, linux-nvdimm@lists.01.org, linux-efi@vger.kernel.org
X-Mailman-Version: 3.1.1
Precedence: list
List-Id: "Linux-nvdimm developer list." <linux-nvdimm.lists.01.org>
Archived-At: <https://lists.01.org/hyperkitty/list/linux-nvdimm@lists.01.org/message/QBK2LFACGKNJYPVZ5OTL6QGT3OCPJYEY/>
